...
export const useAppUI = () => {
  ...
  const [isPreloadedMessagesModalOpen, setIsPreloadedMessagesModalOpen] = useState(false);
  const [isHistorySidebarOpen, setIsHistorySidebarOpen] = useState(window.innerWidth >= 768);
